...
| `python3 -m pytest -q` | **PASS** 652 passed in 14.34s |
| `rad doctor --offline` | **PASS** 20 READY · 0 WARNING · 3 OPTIONAL · 0 ERROR, verdict READY, exit 0 |
| `rad acceptance` | **PASS** 50/50 — `/tmp/rad-g51-gate/acceptance/20260919-080947_gate.json` |
| `rad realworld` | **PASS** 10/11 + 1 BLOCKED — `/tmp/rad-g51-rw/realworld/20260919-081002_realworld.json` |
