...
| This change | **RAD Desktop 0.1 — Authority Foundation** on package **1.0.1**. Authority profiles + Jerry operator + Tauri surface over the existing HTTP API. **Not** a control-plane rewrite. Caps **16/60**. Needle **OFF**. **No GitHub Release / tag.** Not **v1.1.0** |
